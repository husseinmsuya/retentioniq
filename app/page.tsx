...
function Logo() {
  return (
    <Link href="/" className="flex min-w-0 items-center gap-2">
      <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-blue-600 text-white shadow-lg shadow-blue-900/30">
...
function DemoModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[80] grid place-items-center bg-black/70 px-4 py-6 backdrop-blur-sm"
      onClick={onClose}
    >
      <div
        className="max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-2xl border border-white/10 bg-slate-950 p-5 text-white shadow-2xl shadow-blue-950/40 sm:rounded-3xl sm:p-8"
      ...
      >
        ...
        {demoSubmitted ? (
          <div className="mt-8">
            <h3 className="text-2xl font-black sm:text-3xl">Demo Request Submitted</h3>
          ...
          <div className="mt-8">
            <h3 className="text-2xl font-black sm:text-3xl">Book a product demo</h3>
      ...
      <main id="top" className="min-h-screen overflow-hidden bg-white text-slate-950">
        ...
        <nav className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex min-w-0 items-center gap-2">
              ...
              <Link
                href={isSignedIn ? "/dashboard" : "/sign-up"}
                className="hidden rounded-xl bg-blue-600 px-4 py-2 text-sm font-bold text-white shadow-lg shadow-blue-900/20 hover:bg-blue-500 sm:inline-flex"
              >
                Start Free Trial
              </Link>
        ...
        {mobileNavOpen && (
          <div className="fixed inset-0 z-[70] lg:hidden">
            ...
            <div className="absolute right-0 top-0 h-full w-[84vw] max-w-sm overflow-y-auto bg-white p-5 shadow-2xl">
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center justify-between rounded-xl px-4 py-3 text-left text-sm font-black text-slate-700 hover:bg-slate-100"
                    >
                      {item}
              ...
              <div className="mt-8 grid gap-3">
                <Link
                  href="/sign-in"
                  onClick={() => setMobileNavOpen(false)}
                  className="inline-flex h-12 items-center justify-center rounded-xl border border-slate-200 text-sm font-black text-slate-700"
                >
                  Sign In
                </Link>
                ...
                <Link
                  href={isSignedIn ? "/dashboard" : "/sign-up"}
                  onClick={() => setMobileNavOpen(false)}
                  className="inline-flex h-12 items-center justify-center rounded-xl bg-blue-600 text-sm font-black text-white hover:bg-blue-500"
                >
                  Start Free Trial
                </Link>
              </div>
        ...
        <section
          className="relative min-h-[640px] overflow-hidden bg-cover bg-center sm:min-h-[720px]"
          style={{ backgroundImage: `url(${heroImage})` }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-black/75 via-black/45 to-black/20" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-black/10" />

          <div className="relative mx-auto flex min-h-[640px] max-w-7xl items-center justify-center px-4 py-16 text-center sm:min-h-[720px] sm:px-6 sm:py-20 lg:px-8">
            <div className="hero-card max-w-4xl text-white">
              ...
              <h1 className="mx-auto mt-7 max-w-4xl text-4xl font-black leading-[1.05] tracking-tight sm:text-5xl md:text-7xl">
              ...
              <div className="mt-8 grid gap-3 sm:flex sm:flex-wrap sm:justify-center sm:gap-4">
                <Link
                  href={isSignedIn ? "/dashboard" : "/sign-up"}
                  className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 text-sm font-black text-white shadow-2xl shadow-blue-950/40 hover:bg-blue-500 sm:w-auto"
                >
                  Start Free Trial
                  <ArrowRight className="h-4 w-4" />
                </Link>
                ...
                <button
                  ...
                  className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-white/25 bg-white/10 px-6 text-sm font-black text-white backdrop-blur-xl hover:bg-white/20 sm:w-auto"
                >
                ...
                <button
                  ...
                  className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-black/30 px-6 text-sm font-black text-white backdrop-blur-xl hover:bg-black/40 sm:w-auto"
                >
                  Explore Features
              ...
              <div className="mt-7 flex flex-wrap justify-center gap-4 text-sm font-semibold text-slate-100 sm:gap-6">
        ...
        <section id="features" className="bg-white px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section id="solutions" className="bg-slate-950 px-4 py-20 text-white sm:px-6 sm:py-24 lg:px-8">
              ...
              {solutions.map((solution, index) => {
                ...
                return (
                  <div
                    ...
                    className="premium-card rounded-3xl border border-white/10 bg-white/[0.06] p-6 sm:p-7"
                  >
        ...
        <section id="resources" className="bg-slate-50 px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
          <div data-reveal="up" className="mx-auto mb-12 max-w-3xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.26em] text-blue-600">
              Platform Workflow
            </p>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.05fr_0.95fr]">
            <div data-reveal="left">
              <div
                className="float-image min-h-[360px] overflow-hidden rounded-3xl border border-slate-200 bg-cover bg-center shadow-2xl shadow-slate-900/15 sm:min-h-[560px] sm:rounded-[2rem]"
                style={{ backgroundImage: `url(${activeWorkflow.image})` }}
              >
                <div className="flex min-h-[360px] items-end bg-gradient-to-t from-black/75 via-black/20 to-transparent p-5 sm:min-h-[560px] sm:p-8">
                  <div className="max-w-md text-white">
                    ...
                    <h3 className="text-2xl font-black sm:text-3xl">{activeWorkflow.title}</h3>
              ...
              {workflow.map((step, index) => {
                ...
                return (
                  <button
                    ...
                    className={`premium-card rounded-3xl border p-5 text-left transition ${
                      active
        ...
        <section id="pricing" className="bg-white px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
          <div data-reveal="up" className="mx-auto mb-12 max-w-3xl text-center">
            <p className="text-xs font-black uppercase tracking-[0.26em] text-blue-600">
              Pricing
            </p>
        ...
        <section id="company" className="bg-slate-950 px-4 py-20 text-white sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <div className="mt-9 flex flex-wrap justify-center gap-4">
                <button
                  type="button"
                  onClick={() => setDemoOpen(true)}
                  className="inline-flex h-14 w-full items-center justify-center gap-3 rounded-xl bg-emerald-500 px-8 text-base font-black text-white shadow-lg shadow-emerald-950/20 hover:bg-emerald-400 sm:w-auto"
                >
                ...
                <button
                  type="button"
                  onClick={() => setDemoOpen(true)}
                  className="inline-flex h-14 w-full items-center justify-center gap-3 rounded-xl border border-emerald-400 px-8 text-base font-black text-emerald-100 hover:bg-emerald-500/10 sm:w-auto"
                >
